...
function getEndpoints(deviceAddress, endpoints) {
    // var myEndpoint = endpoints.addEndpoint(
    //     "AI1_CONNECTED",
    //     { en: "Analog input #1 - WHP", es: "Entrada analógica #1 - WHP" },
    //     endpointType.genericSensor
    // ).variableTypeId = 1333;

    var myEndpoint = endpoints.addEndpoint("1", "AI1_CONNECTED", endpointType.temperatureSensor);    
    ...
    alert.normalThreshold = 30;
    alert.minimumDurationSeconds = 22
    alert.severity = alarmSeverity.Information;
    alert.notificationEmails = ['miguel.ponce@cloud.studio', 'miguelponceg87@gmail.com'];
    alert.emailTemplates = { openTemplate: "miguel.ponce@email.com", closeTemplate: "juan.perez@email.com" };
    alert.tags = ['sos', 'alert'];

    var ap_lt = endpoints.addEndpoint("2", "AP_LT", endpointType.pressureSensor);
    
    var alert2 = ap_lt.addAlert();
    alert2.variableTypeId = variableType.pressure;
    alert2.conditionType = conditionType.greater;
    alert2.threshold = 25;
    alert2.normalConditionType = conditionType.lowerOrEqual;
    alert2.normalThreshold = 20;
    alert2.severity = alarmSeverity.medium;
    //alert2.notificationSmsNumbers  = ['+51977972091', '+51977972091'];
    alert2.notificationVoiceNumbers = ['+51977972091', '+51977972091'];
    alert2.voiceTemplates = { openTemplate: "miguel.ponce@email.com", closeTemplate: "juan.perez@email.com" };
    alert2.smsTemplates = { openTemplate: "miguel.ponce@email.com", closeTemplate: "juan.perez@email.com" };
}
